...
var nombreCompleto2 = 'Maria' + ' ' + 'Dominguez'; // Segunda Concatenación
console.log(nombreCompleto2);
var juntos = nombre + 219; //Lee de izquierda a derecha siguiendo la cadena, lee el num como str
console.log(juntos);
...
//apellido2 = "Peres"; es una constante no puede ser modificada
